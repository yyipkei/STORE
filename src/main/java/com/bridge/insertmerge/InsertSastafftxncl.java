...
public class InsertSastafftxncl {

	private static final Logger logger = Logger
			.getLogger(InsertSastafftxncl.class);

	public static boolean Sastafftxnclinsert(String rsrowguid, String rstxdate,
		...
		try {
			...
			if (Objects.equals(frdatabase, "Oracle")) {
				...
				insertTableSQL = "INSERT INTO Sastafftxn_cl"
	...
	public static boolean Sastafftxnclupdate(String rsrowguid, String rstxdate,
			String rsloccode, String rsregno, String rstxno, String rsseqno,
			String rstxtype, String rsvoid, String rstender, String rsamount,
			String rsforeignamt, String rsstaffid, String rsstaffloccode,
			String rsqty, Timestamp rslastupddt, String frdatabase)
		...
		try {
			...
			String updateSQL = "UPDATE Sastafftxn_cl "
					+ "SET  TX_TYPE        = ? " + ", VOID           = ? "
					+ ", TENDER         = ? " + ", AMOUNT         = ? "
	...
	public static boolean Sastafftxnclchkexists(String entitykey,
		...
		try {
			...
			String selectSQL = "SELECT TX_DATE " + "FROM Sastafftxn_cl "
