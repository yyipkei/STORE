...
public class InsertSastaffdiscdtlcl {

	private static final Logger logger = Logger
			.getLogger(InsertSastaffdiscdtlcl.class);

	public static boolean Sastaffdiscdtlclinsert(String rscompanycde,
		...
		insertTableSQL = "INSERT INTO sa_staff_disc_dtl_cl (COMPANY_CDE,BATCH_NO,VER_NO,SEQ_NO,CARD_TYPE,"
				+ "BU_CDE,PROD_TYPE,DISC_PER,LAST_UPD_DT,LAST_UPD_USR,LAST_UPD_VER,ENTITY_KEY) "
				+ "VALUES ( ?,?,?,?,?,?,?,?,?,?,?,? )";
	...
	public static boolean Sastaffdiscdtlclupdate(String rscompanycde,
			String rsbatchno, String rsverno, String rsseqno,
			String rscardtype, String rsbucde, String rsprodtype,
			String rsdiscper, Timestamp rslastupddt, String rslastupdusr,
			String rslastupdver, String rsentitykey, String frdatabase)
		...
		updateSQL = "UPDATE SA_STAFF_DISC_DTL_CL " + "SET COMPANY_CDE = ? "
				+ ", BATCH_NO      = ? " + ", VER_NO        = ? "
				+ ", SEQ_NO        = ? " + ", CARD_TYPE     = ? "
				+ ", BU_CDE        = ? " + ", PROD_TYPE     = ? "
	...
	public static boolean Sastaffdiscdtlclchkexists(String entitykey,
		...
		try {
			...
			String selectSQL = "SELECT COMPANY_CDE "
					+ "FROM SA_STAFF_DISC_DTL_CL " + "where ENTITY_KEY ='"
					+ entitykey + "'";
