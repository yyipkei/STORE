...
public class InsertSastaffdischdrcl {

	private static final Logger logger = Logger
			.getLogger(InsertSastaffdischdrcl.class);

	public static boolean Sastaffdischdrclinsert(String rscompanycde,
		...
		insertTableSQL = "INSERT INTO SA_STAFF_DISC_HDR_CL (COMPANY_CDE,BATCH_NO,BATCH_DESC,VER_NO,"
				+ "CURR_VER,STATUS,EFF_DT_FR,EFF_DT_TO,PREPARE_BY,CFM_DT,"
				+ "CFM_BY,APP_DT,APP_BY,LAST_UPD_DT,LAST_UPD_USR,LAST_UPD_VER,ENTITY_KEY) "
				+ "VALUES ( ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,? )";
	...
	public static boolean Sastaffdischdrclupdate(String rscompanycde,
			String rsbatchno, String rsbatchdesc, String rsverno,
			String rscurrver, String rsstatus, Timestamp rseffdtfr,
			Timestamp rseffdtto, String rsprepareby, Timestamp rscfmdt,
			String rscfmby, Timestamp rsappdt, String rsappby,
		...
		updateSQL = "UPDATE SA_STAFF_DISC_HDR_CL " + "SET  COMPANY_CDE = ? "
				+ ", BATCH_NO      = ? " + ", BATCH_DESC    = ? "
				+ ", VER_NO        = ? " + ", CURR_VER      = ? "
				+ ", STATUS        = ? " + ", EFF_DT_FR     = ? "
	...
	public static boolean Sastaffdischdrclchkexists(String entitykey,
		...
		try {
			...
			String selectSQL = "SELECT COMPANY_CDE "
					+ "FROM SA_STAFF_DISC_HDR_CL " + "where ENTITY_KEY ='"
					+ entitykey + "'";
