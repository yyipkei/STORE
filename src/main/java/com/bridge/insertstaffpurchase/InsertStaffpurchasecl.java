...
public class InsertStaffpurchasecl {

	private static final Logger logger = Logger
			.getLogger(InsertStaffpurchasecl.class);

	public static boolean Staffpurchaseclinsert(String rscompany,
		...
		insertTableSQL = "INSERT INTO STAFF_PURCHASE_CL (COMPANY,STAFF_ID,NAME,SPOUSE_NAME,"
				+ "CARD_TYPE,CREDIT_LIMIT,LOC_DESC,DIV_DESC,DEPT_DESC,ACTIVE,STAFF_LOC_CODE,"
	...
	public static boolean Staffpurchaseclupdate(String rscompany,
			String rsstaffid, String rsname, String rsspousename,
			String rscardtype, String rscreditlimit, String rslocdesc,
			String rsdivdesc, String rsdeptdesc, String rsactive,
			String rsstaffloccode, String rsaccumpurchase, String rsdeptcde,
		...
		updateSQL = "UPDATE STAFF_PURCHASE_CL " + "SET COMPANY      = ? "
				+ ", STAFF_ID       = ? " + ", NAME           = ? "
	...
	public static boolean Staffpurchaseclchkexists(String entitykey,
			String frdatabase) throws SQLException {
		/*
		...
		try {
			...
			String selectSQL = "SELECT COMPANY "
					+ "FROM STAFF_PURCHASE_CL " + "where ENTITY_KEY ='"
					+ entitykey + "'";
			...
			while (rs.next()) {
				String rschktxdate = rs.getString("COMPANY");
