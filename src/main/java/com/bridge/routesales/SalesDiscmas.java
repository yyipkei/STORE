 ...
 */
public class SalesDiscmas {

    private static final Logger logger = Logger.getLogger(SalesDiscmas.class);

    public static void routeSalesDiscmas(String dataupdatelog, String entityname,
        ...
        try {
            ...
            while (rs.next()) {
                ...
                boolean Chkresult = InsertSalesDiscmas.SalesDiscmaschkexists(entitykey,
                        database);
                ...
                if (!Chkresult) {
                    ...
                    boolean Insertresult = InsertSalesDiscmas.SalesDiscmasinsert(rsdiscid, rsdiscname, rsdiscper, rsdiscamt, rsdisctype, rsallowover,
                  ...
                  /* if ((!"Oracle".equals(database)) && (Insertresult)) {
                    ...
                    boolean Insertresult = InsertSalesDiscmas.SalesDiscmasupdate(rsdiscid, rsdiscname, rsdiscper, rsdiscamt, rsdisctype, rsallowover,
                            rsreasongroup, rsdisctxitem, rsloctype, rsdiscflag, rsefffrdate, rsefftodate, rspurchaseflag, rspurchaseqty, rspurchaseamt,
                            rsopenceiling, rsstatus, rsversion, rsdraftdate, rsdraftby, rscfmdt, rscfmby, rsappdt, rsappby, rsextradiscid, rslastupddt
                            , rslastupdusr, rslastupdver, rscontrolid, rsentitykey, database);
