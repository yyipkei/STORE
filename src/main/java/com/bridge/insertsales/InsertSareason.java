...
public class InsertSareason {

	private static final Logger logger = Logger.getLogger(InsertSareason.class);

	public static boolean Sareasoninsert(String rstxdate, String rsloccode,
			String rsregno, String rstxno, String rsseqno, String rstxtype,
			String rsvoid, String rsreasongrp, String rsreason,
		...
		try {
			...
			String insertTableSQL = "INSERT INTO Sareason"
					+ "(TX_DATE, LOC_CODE,REG_NO, TX_NO, SEQ_NO, TX_TYPE, VOID, REASON_GROUP, REASON, LAST_UPD_DT) "
					+ "VALUES" + "(?,?,?,?,?,?,?,?,?,?)";
			...
			preparedStatement.setString(8, rsreasongrp);
	...
	public static boolean Sareasonupdate(String rstxdate, String rsloccode,
			String rsregno, String rstxno, String rsseqno, String rstxtype,
			String rsvoid, String rsreasongrp, String rsreason,
			Timestamp rslastupddt, String frdatabase) throws SQLException {
		...
		try {
			...
			String updateSQL = "UPDATE SAREASON "
					+ "SET TX_TYPE      = ?, VOID         = ?, REASON_GROUP = ? "
					+ ", REASON       = ?, LAST_UPD_DT  = ? "
			...
			preparedStatement.setString(3, rsreasongrp);
			preparedStatement.setString(4, rsreason);
			...
			preparedStatement.setString(10, rsseqno);
	...
	public static boolean Sareasonchkexists(String entitykey, String frdatabase)
			throws SQLException {
		...
		try {
			...
			String selectSQL = "SELECT TX_DATE " + "FROM Sareason "
