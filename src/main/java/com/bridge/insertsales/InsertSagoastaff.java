...
public class InsertSagoastaff {

	private static final Logger logger = Logger.getLogger(InsertSagoastaff.class);

	public static boolean Sagoastaffinsert(String rstxdate, String rsloccode,
			String rsregno, String rstxno, String rsseqno, String rstxtype,
			String rsvoid, String rsstaffid, Timestamp rslastupddt,
		...
		try {
			...
			String insertTableSQL = "INSERT INTO SAGOA_STAFF"
					+ "(TX_DATE,LOC_CODE,REG_NO,TX_NO,SEQ_NO,TX_TYPE,VOID,STAFF_ID,LAST_UPD_DT) "
					+ "VALUES" + "(?,?,?,?,?,?,?,?,?)";
	...
	public static boolean Sagoastaffupdate(String rstxdate, String rsloccode,
			String rsregno, String rstxno, String rsseqno, String rstxtype,
			String rsvoid, String rsstaffid, Timestamp rslastupddt,
			String frdatabase) throws SQLException {
		...
		try {
			...
			String updateSQL = "UPDATE SAGOA_STAFF " + "SET  TX_TYPE     = ? "
					+ ", VOID        = ? " + ", STAFF_ID    = ? "
	...
	public static boolean Sagoastaffchkexists(String entitykey, String frdatabase)
			throws SQLException {
		...
		try {
			...
			String selectSQL = "SELECT TX_DATE " + "FROM SAGOA_STAFF "
