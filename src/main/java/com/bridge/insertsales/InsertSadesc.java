...
public class InsertSadesc {

	private static final Logger logger = Logger.getLogger(InsertSadesc.class);

	public static boolean Sadescinsert(String rstxdate, String rsloccode,
			String rsregno, String rstxno, String rsseqno, String rstxtype,
			String rsvoid, String rssku, String rsdescsp,
		...
		try {
			...
			String insertTableSQL = "INSERT INTO Sadesc"
					+ "(TX_DATE,LOC_CODE,REG_NO,TX_NO,SEQ_NO,TX_TYPE,VOID,SKU, DESC_SP, LAST_UPD_DT) "
					+ "VALUES" + "( ?, ?, ?, ?,  ?, ?, ?, ?,  ?, ? )";
			...
			preparedStatement.setString(9, rsdescsp);
	...
	public static boolean Sadescupdate(String rstxdate, String rsloccode,
			String rsregno, String rstxno, String rsseqno, String rstxtype,
			String rsvoid, String rssku, String rsdescsp,
			Timestamp rslastupddt, String frdatabase) throws SQLException {
		...
		try {
			...
			String updateSQL = "UPDATE SADESC " + "SET TX_TYPE     = ? "
					+ ", VOID        = ? " + ", SKU         = ? "
					+ ", DESC_SP     = ? " + ", LAST_UPD_DT = ? "
	...
	public static boolean Sadescchkexists(String entitykey, String frdatabase)
			throws SQLException {
		...
		try {
			...
			String selectSQL = "SELECT TX_DATE " + "FROM Sadesc "
